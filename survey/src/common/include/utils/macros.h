...
#define VEHICLE_PLATFORM_HUNTER (5)
#define VEHICLE_PLATFORM VEHICLE_PLATFORM_HUNTER
...
#define DEV_IMU_TYPE_F9K (4)
#define DEV_IMU_TYPE_ZHD_RTK (5)
#define DEV_IMU_TYPE DEV_IMU_TYPE_ZHD_RTK

/// 定义Laser设备的类型
#define DEV_LASER_TYPE_UNDEFINED (0)
#define DEV_LASER_TYPE_RANGRING (1)
#define DEV_LASER_TYPE_JRT (2)
#define DEV_LASER_TYPE DEV_LASER_TYPE_JRT

/// 定义加粉Laser设备的类型
#define DEV_POWDER_LASER_TYPE_UNDEFINED (0)
#define DEV_POWDER_LASER_TYPE_LI (1)
#define DEV_POWDER_LASER_TYPE DEV_POWDER_LASER_TYPE_LI
...
#define ENABLE_LCM_NODE (0)
#define ENABLE_UDP_NODE (0)
