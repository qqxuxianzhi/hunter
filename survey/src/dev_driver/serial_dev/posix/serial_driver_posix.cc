...
bool SerialDriverPosix::OpenPort(const SerialPortParam& param) {
  ...
  case (SerialPortParam::BAUD_RATE_230400):
    ...
    break;
  case (SerialPortParam::BAUD_RATE_460800):
    cfsetispeed(&newtio, B460800);
    cfsetospeed(&newtio, B460800);
    break;
  case (SerialPortParam::BAUD_RATE_500000):
    cfsetispeed(&newtio, B500000);
    cfsetospeed(&newtio, B500000);
    break;
  case (SerialPortParam::BAUD_RATE_576000):
    cfsetispeed(&newtio, B576000);
    cfsetospeed(&newtio, B576000);
    break;
  case (SerialPortParam::BAUD_RATE_921600):
    cfsetispeed(&newtio, B921600);
    cfsetospeed(&newtio, B921600);
    break;
   case (SerialPortParam::BAUD_RATE_1000000):
